...
def index():
    ...
    # Subjects scoped to current school + year (prevents cross-school data in the dropdown)
    if school and year:
    ...
    if subject_filter != 'all':
        try:
            ...
            if matched_sub is None:
                subject_filter = 'all'
            elif grade_filter and matched_sub.grade_id and matched_sub.grade_id != grade_filter:
                subject_filter = 'all'
            elif stage_filter and not grade_filter and matched_sub.stage and matched_sub.stage != stage_filter:
                subject_filter = 'all'
