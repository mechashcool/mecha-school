...
Iraqi public education has 15 standard grades across three stages:
  - ابتدائية  (Primary)              : grades 1–6
  - متوسطة   (Intermediate)          : grades 7–9
  - إعدادية  (Preparatory Scientific): grades 10–12 علمي
  - إعدادية  (Preparatory Literary)  : grades 10–12 أدبي
...
IRAQI_STANDARD_GRADES: list[tuple[str, str]] = [
    ...
    ('الصف الرابع الإعدادي العلمي',   'إعدادية'),
    ('الصف الخامس الإعدادي العلمي',   'إعدادية'),
    ('الصف السادس الإعدادي العلمي',   'إعدادية'),
    ('الصف الرابع الإعدادي الأدبي',   'إعدادية'),
    ('الصف الخامس الإعدادي الأدبي',   'إعدادية'),
    ('الصف السادس الإعدادي الأدبي',   'إعدادية'),
]
